...
static PyObject* pyopencv_cv_ximgproc_createDisparityDTFilter(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::ximgproc;

    Ptr<DisparityDTFilter> retval;

    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ERRWRAP2(retval = cv::ximgproc::createDisparityDTFilter());
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_ximgproc_createDisparityGuidedFilter(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::ximgproc;

    Ptr<DisparityGuidedFilter> retval;

    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ERRWRAP2(retval = cv::ximgproc::createDisparityGuidedFilter());
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_ximgproc_createDisparityWLSFilter(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ERRWRAP2(retval = cv::ximgproc::createDisparityWLSFilter());
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_ximgproc_createWeightedLeastSquaresFilter(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::ximgproc;
    ...
    double sigma_color=0;
    int num_iter=3;
    Ptr<WeightedLeastSquaresFilter> retval;

    const char* keywords[] = { "guide", "lambda", "sigma_color", "num_iter", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "Odd|i:createWeightedLeastSquaresFilter", (char**)keywords, &pyobj_guide, &lambda, &sigma_color, &num_iter) &&
        pyopencv_to(pyobj_guide, guide, ArgInfo("guide", 0)) )
    {
        ERRWRAP2(retval = cv::ximgproc::createWeightedLeastSquaresFilter(guide, lambda, sigma_color, num_iter));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_ximgproc_weightedLeastSquaresFilter(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::ximgproc;
    ...
    const char* keywords[] = { "guide", "src", "lambda", "sigma_color", "dst", "num_iter", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOdd|Oi:weightedLeastSquaresFilter", (char**)keywords, &pyobj_guide, &pyobj_src, &lambda, &sigma_color, &pyobj_dst, &num_iter) &&
        pyopencv_to(pyobj_guide, guide, ArgInfo("guide", 0)) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 1)) )
    {
        ERRWRAP2(cv::ximgproc::weightedLeastSquaresFilter(guide, src, dst, lambda, sigma_color, num_iter));
        return pyopencv_from(dst);
    }
