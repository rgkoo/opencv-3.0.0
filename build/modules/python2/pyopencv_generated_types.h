...
struct pyopencv_lsvm_LSVMDetector_t
{
    PyObject_HEAD
    Ptr<cv::lsvm::LSVMDetector> v;
};

static PyTypeObject pyopencv_lsvm_LSVMDetector_Type =
{
    PyObject_HEAD_INIT(&PyType_Type)
0,
    MODULESTR".lsvm_LSVMDetector",
    sizeof(pyopencv_lsvm_LSVMDetector_t),
};

static void pyopencv_lsvm_LSVMDetector_dealloc(PyObject* self)
{
    ((pyopencv_lsvm_LSVMDetector_t*)self)->v.release();
    PyObject_Del(self);
}

template<> PyObject* pyopencv_from(const Ptr<cv::lsvm::LSVMDetector>& r)
{
    pyopencv_lsvm_LSVMDetector_t *m = PyObject_NEW(pyopencv_lsvm_LSVMDetector_t, &pyopencv_lsvm_LSVMDetector_Type);
    new (&(m->v)) Ptr<cv::lsvm::LSVMDetector>(); // init Ptr with placement new
    m->v = r;
    return (PyObject*)m;
}

template<> bool pyopencv_to(PyObject* src, Ptr<cv::lsvm::LSVMDetector>& dst, const char* name)
{
    if( src == NULL || src == Py_None )
        return true;
    if(!PyObject_TypeCheck(src, &pyopencv_lsvm_LSVMDetector_Type))
    {
        failmsg("Expected cv::lsvm::LSVMDetector for argument '%s'", name);
        return false;
    }
    dst = ((pyopencv_lsvm_LSVMDetector_t*)src)->v.dynamicCast<cv::lsvm::LSVMDetector>();
    return true;
}


struct pyopencv_lsvm_LSVMDetector_ObjectDetection_t
{
    PyObject_HEAD
    Ptr<cv::lsvm::LSVMDetector::ObjectDetection> v;
};

static PyTypeObject pyopencv_lsvm_LSVMDetector_ObjectDetection_Type =
{
    PyObject_HEAD_INIT(&PyType_Type)
0,
    MODULESTR".lsvm_LSVMDetector_ObjectDetection",
    sizeof(pyopencv_lsvm_LSVMDetector_ObjectDetection_t),
};

static void pyopencv_lsvm_LSVMDetector_ObjectDetection_dealloc(PyObject* self)
{
    ((pyopencv_lsvm_LSVMDetector_ObjectDetection_t*)self)->v.release();
    PyObject_Del(self);
}

template<> PyObject* pyopencv_from(const Ptr<cv::lsvm::LSVMDetector::ObjectDetection>& r)
{
    pyopencv_lsvm_LSVMDetector_ObjectDetection_t *m = PyObject_NEW(pyopencv_lsvm_LSVMDetector_ObjectDetection_t, &pyopencv_lsvm_LSVMDetector_ObjectDetection_Type);
    new (&(m->v)) Ptr<cv::lsvm::LSVMDetector::ObjectDetection>(); // init Ptr with placement new
    m->v = r;
    return (PyObject*)m;
}

template<> bool pyopencv_to(PyObject* src, Ptr<cv::lsvm::LSVMDetector::ObjectDetection>& dst, const char* name)
{
    if( src == NULL || src == Py_None )
        return true;
    if(!PyObject_TypeCheck(src, &pyopencv_lsvm_LSVMDetector_ObjectDetection_Type))
    {
        failmsg("Expected cv::lsvm::LSVMDetector::ObjectDetection for argument '%s'", name);
        return false;
    }
    dst = ((pyopencv_lsvm_LSVMDetector_ObjectDetection_t*)src)->v.dynamicCast<cv::lsvm::LSVMDetector::ObjectDetection>();
    return true;
}
...
struct pyopencv_ximgproc_DisparityDTFilter_t
{
    PyObject_HEAD
    Ptr<cv::Algorithm> v;
};

static PyTypeObject pyopencv_ximgproc_DisparityDTFilter_Type =
{
    PyObject_HEAD_INIT(&PyType_Type)
0,
    MODULESTR".ximgproc_DisparityDTFilter",
    sizeof(pyopencv_ximgproc_DisparityDTFilter_t),
};

static void pyopencv_ximgproc_DisparityDTFilter_dealloc(PyObject* self)
{
    ((pyopencv_ximgproc_DisparityDTFilter_t*)self)->v.release();
    PyObject_Del(self);
}

template<> PyObject* pyopencv_from(const Ptr<cv::ximgproc::DisparityDTFilter>& r)
{
    pyopencv_ximgproc_DisparityDTFilter_t *m = PyObject_NEW(pyopencv_ximgproc_DisparityDTFilter_t, &pyopencv_ximgproc_DisparityDTFilter_Type);
    new (&(m->v)) Ptr<cv::Algorithm>(); // init Ptr with placement new
    m->v = r;
    return (PyObject*)m;
}

template<> bool pyopencv_to(PyObject* src, Ptr<cv::ximgproc::DisparityDTFilter>& dst, const char* name)
{
    if( src == NULL || src == Py_None )
        return true;
    if(!PyObject_TypeCheck(src, &pyopencv_ximgproc_DisparityDTFilter_Type))
    {
        failmsg("Expected cv::ximgproc::DisparityDTFilter for argument '%s'", name);
        return false;
    }
    dst = ((pyopencv_ximgproc_DisparityDTFilter_t*)src)->v.dynamicCast<cv::ximgproc::DisparityDTFilter>();
    return true;
}
...
struct pyopencv_ximgproc_DisparityGuidedFilter_t
{
    PyObject_HEAD
    Ptr<cv::Algorithm> v;
};

static PyTypeObject pyopencv_ximgproc_DisparityGuidedFilter_Type =
{
    PyObject_HEAD_INIT(&PyType_Type)
0,
    MODULESTR".ximgproc_DisparityGuidedFilter",
    sizeof(pyopencv_ximgproc_DisparityGuidedFilter_t),
};

static void pyopencv_ximgproc_DisparityGuidedFilter_dealloc(PyObject* self)
{
    ((pyopencv_ximgproc_DisparityGuidedFilter_t*)self)->v.release();
    PyObject_Del(self);
}

template<> PyObject* pyopencv_from(const Ptr<cv::ximgproc::DisparityGuidedFilter>& r)
{
    pyopencv_ximgproc_DisparityGuidedFilter_t *m = PyObject_NEW(pyopencv_ximgproc_DisparityGuidedFilter_t, &pyopencv_ximgproc_DisparityGuidedFilter_Type);
    new (&(m->v)) Ptr<cv::Algorithm>(); // init Ptr with placement new
    m->v = r;
    return (PyObject*)m;
}

template<> bool pyopencv_to(PyObject* src, Ptr<cv::ximgproc::DisparityGuidedFilter>& dst, const char* name)
{
    if( src == NULL || src == Py_None )
        return true;
    if(!PyObject_TypeCheck(src, &pyopencv_ximgproc_DisparityGuidedFilter_Type))
    {
        failmsg("Expected cv::ximgproc::DisparityGuidedFilter for argument '%s'", name);
        return false;
    }
    dst = ((pyopencv_ximgproc_DisparityGuidedFilter_t*)src)->v.dynamicCast<cv::ximgproc::DisparityGuidedFilter>();
    return true;
}
...
struct pyopencv_ximgproc_WeightedLeastSquaresFilter_t
{
    PyObject_HEAD
    Ptr<cv::Algorithm> v;
};

static PyTypeObject pyopencv_ximgproc_WeightedLeastSquaresFilter_Type =
{
    PyObject_HEAD_INIT(&PyType_Type)
0,
    MODULESTR".ximgproc_WeightedLeastSquaresFilter",
    sizeof(pyopencv_ximgproc_WeightedLeastSquaresFilter_t),
};

static void pyopencv_ximgproc_WeightedLeastSquaresFilter_dealloc(PyObject* self)
{
    ((pyopencv_ximgproc_WeightedLeastSquaresFilter_t*)self)->v.release();
    PyObject_Del(self);
}

template<> PyObject* pyopencv_from(const Ptr<cv::ximgproc::WeightedLeastSquaresFilter>& r)
{
    pyopencv_ximgproc_WeightedLeastSquaresFilter_t *m = PyObject_NEW(pyopencv_ximgproc_WeightedLeastSquaresFilter_t, &pyopencv_ximgproc_WeightedLeastSquaresFilter_Type);
    new (&(m->v)) Ptr<cv::Algorithm>(); // init Ptr with placement new
    m->v = r;
    return (PyObject*)m;
}

template<> bool pyopencv_to(PyObject* src, Ptr<cv::ximgproc::WeightedLeastSquaresFilter>& dst, const char* name)
{
    if( src == NULL || src == Py_None )
        return true;
    if(!PyObject_TypeCheck(src, &pyopencv_ximgproc_WeightedLeastSquaresFilter_Type))
    {
        failmsg("Expected cv::ximgproc::WeightedLeastSquaresFilter for argument '%s'", name);
        return false;
    }
    dst = ((pyopencv_ximgproc_WeightedLeastSquaresFilter_t*)src)->v.dynamicCast<cv::ximgproc::WeightedLeastSquaresFilter>();
    return true;
}
...
static PyObject* pyopencv_lsvm_LSVMDetector_repr(PyObject* self)
{
    char str[1000];
    sprintf(str, "<lsvm_LSVMDetector %p>", self);
    return PyString_FromString(str);
}



static PyGetSetDef pyopencv_lsvm_LSVMDetector_getseters[] =
{
    {NULL}  /* Sentinel */
};
...
static PyMethodDef pyopencv_lsvm_LSVMDetector_methods[] =
{

    {NULL,          NULL}
};

static void pyopencv_lsvm_LSVMDetector_specials(void)
{
    pyopencv_lsvm_LSVMDetector_Type.tp_base = NULL;
    pyopencv_lsvm_LSVMDetector_Type.tp_dealloc = pyopencv_lsvm_LSVMDetector_dealloc;
    pyopencv_lsvm_LSVMDetector_Type.tp_repr = pyopencv_lsvm_LSVMDetector_repr;
    pyopencv_lsvm_LSVMDetector_Type.tp_getset = pyopencv_lsvm_LSVMDetector_getseters;
    pyopencv_lsvm_LSVMDetector_Type.tp_methods = pyopencv_lsvm_LSVMDetector_methods;
}

static PyObject* pyopencv_lsvm_LSVMDetector_ObjectDetection_repr(PyObject* self)
{
    char str[1000];
    sprintf(str, "<lsvm_LSVMDetector_ObjectDetection %p>", self);
    return PyString_FromString(str);
}



static PyGetSetDef pyopencv_lsvm_LSVMDetector_ObjectDetection_getseters[] =
{
    {NULL}  /* Sentinel */
};
...
static PyMethodDef pyopencv_lsvm_LSVMDetector_ObjectDetection_methods[] =
{

    {NULL,          NULL}
};

static void pyopencv_lsvm_LSVMDetector_ObjectDetection_specials(void)
{
    pyopencv_lsvm_LSVMDetector_ObjectDetection_Type.tp_base = NULL;
    pyopencv_lsvm_LSVMDetector_ObjectDetection_Type.tp_dealloc = pyopencv_lsvm_LSVMDetector_ObjectDetection_dealloc;
    pyopencv_lsvm_LSVMDetector_ObjectDetection_Type.tp_repr = pyopencv_lsvm_LSVMDetector_ObjectDetection_repr;
    pyopencv_lsvm_LSVMDetector_ObjectDetection_Type.tp_getset = pyopencv_lsvm_LSVMDetector_ObjectDetection_getseters;
    pyopencv_lsvm_LSVMDetector_ObjectDetection_Type.tp_methods = pyopencv_lsvm_LSVMDetector_ObjectDetection_methods;
}
...
static PyObject* pyopencv_cv_ximgproc_ximgproc_DisparityFilter_filter(PyObject* self, PyObject* args, PyObject* kw)
{
    ...
    PyObject* pyobj_disparity_map = NULL;
    Mat disparity_map;
    ...
    const char* keywords[] = { "disparity_map", "left_view", "ROI", "filtered_disparity_map", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO|O:ximgproc_DisparityFilter.filter", (char**)keywords, &pyobj_disparity_map, &pyobj_left_view, &pyobj_ROI, &pyobj_filtered_disparity_map) &&
        pyopencv_to(pyobj_disparity_map, disparity_map, ArgInfo("disparity_map", 0)) &&
    ...
    {
        ERRWRAP2(_self_->filter(disparity_map, left_view, filtered_disparity_map, ROI));
...
{
    {"filter", (PyCFunction)pyopencv_cv_ximgproc_ximgproc_DisparityFilter_filter, METH_VARARGS | METH_KEYWORDS, "filter(disparity_map, left_view, ROI[, filtered_disparity_map]) -> filtered_disparity_map"},
...
static PyObject* pyopencv_ximgproc_DisparityDTFilter_repr(PyObject* self)
{
    char str[1000];
    sprintf(str, "<ximgproc_DisparityDTFilter %p>", self);
    return PyString_FromString(str);
}



static PyGetSetDef pyopencv_ximgproc_DisparityDTFilter_getseters[] =
{
    {NULL}  /* Sentinel */
};

static PyObject* pyopencv_cv_ximgproc_ximgproc_DisparityDTFilter_getSigmaColor(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv::ximgproc;

    if(!PyObject_TypeCheck(self, &pyopencv_ximgproc_DisparityDTFilter_Type))
        return failmsgp("Incorrect type of self (must be 'ximgproc_DisparityDTFilter' or its derivative)");
    cv::ximgproc::DisparityDTFilter* _self_ = dynamic_cast<cv::ximgproc::DisparityDTFilter*>(((pyopencv_ximgproc_DisparityDTFilter_t*)self)->v.get());
    double retval;
...
static PyObject* pyopencv_cv_ximgproc_ximgproc_DisparityDTFilter_getSigmaSpatial(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv::ximgproc;
...
static PyObject* pyopencv_cv_ximgproc_ximgproc_DisparityDTFilter_setSigmaColor(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv::ximgproc;
    ...
    const char* keywords[] = { "_sigmaColor", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "d:ximgproc_DisparityDTFilter.setSigmaColor", (char**)keywords, &_sigmaColor) )
    {
        ERRWRAP2(_self_->setSigmaColor(_sigmaColor));
        Py_RETURN_NONE;
    }
...
static PyObject* pyopencv_cv_ximgproc_ximgproc_DisparityDTFilter_setSigmaSpatial(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv::ximgproc;
    ...
    if(!PyObject_TypeCheck(self, &pyopencv_ximgproc_DisparityDTFilter_Type))
        return failmsgp("Incorrect type of self (must be 'ximgproc_DisparityDTFilter' or its derivative)");
    cv::ximgproc::DisparityDTFilter* _self_ = dynamic_cast<cv::ximgproc::DisparityDTFilter*>(((pyopencv_ximgproc_DisparityDTFilter_t*)self)->v.get());
    double _sigmaSpatial=0;

    const char* keywords[] = { "_sigmaSpatial", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "d:ximgproc_DisparityDTFilter.setSigmaSpatial", (char**)keywords, &_sigmaSpatial) )
    {
        ERRWRAP2(_self_->setSigmaSpatial(_sigmaSpatial));
        Py_RETURN_NONE;
    }
...
static PyMethodDef pyopencv_ximgproc_DisparityDTFilter_methods[] =
{
    {"getSigmaColor", (PyCFunction)pyopencv_cv_ximgproc_ximgproc_DisparityDTFilter_getSigmaColor, METH_VARARGS | METH_KEYWORDS, "getSigmaColor() -> retval"},
    {"getSigmaSpatial", (PyCFunction)pyopencv_cv_ximgproc_ximgproc_DisparityDTFilter_getSigmaSpatial, METH_VARARGS | METH_KEYWORDS, "getSigmaSpatial() -> retval"},
    {"setSigmaColor", (PyCFunction)pyopencv_cv_ximgproc_ximgproc_DisparityDTFilter_setSigmaColor, METH_VARARGS | METH_KEYWORDS, "setSigmaColor(_sigmaColor) -> None"},
    {"setSigmaSpatial", (PyCFunction)pyopencv_cv_ximgproc_ximgproc_DisparityDTFilter_setSigmaSpatial, METH_VARARGS | METH_KEYWORDS, "setSigmaSpatial(_sigmaSpatial) -> None"},

    {NULL,          NULL}
};

static void pyopencv_ximgproc_DisparityDTFilter_specials(void)
{
    pyopencv_ximgproc_DisparityDTFilter_Type.tp_base = &pyopencv_ximgproc_DisparityFilter_Type;
    pyopencv_ximgproc_DisparityDTFilter_Type.tp_dealloc = pyopencv_ximgproc_DisparityDTFilter_dealloc;
    pyopencv_ximgproc_DisparityDTFilter_Type.tp_repr = pyopencv_ximgproc_DisparityDTFilter_repr;
    pyopencv_ximgproc_DisparityDTFilter_Type.tp_getset = pyopencv_ximgproc_DisparityDTFilter_getseters;
    pyopencv_ximgproc_DisparityDTFilter_Type.tp_methods = pyopencv_ximgproc_DisparityDTFilter_methods;
}

static PyObject* pyopencv_ximgproc_DisparityGuidedFilter_repr(PyObject* self)
{
    char str[1000];
    sprintf(str, "<ximgproc_DisparityGuidedFilter %p>", self);
    return PyString_FromString(str);
}



static PyGetSetDef pyopencv_ximgproc_DisparityGuidedFilter_getseters[] =
{
    {NULL}  /* Sentinel */
};

static PyObject* pyopencv_cv_ximgproc_ximgproc_DisparityGuidedFilter_getEps(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv::ximgproc;

    if(!PyObject_TypeCheck(self, &pyopencv_ximgproc_DisparityGuidedFilter_Type))
        return failmsgp("Incorrect type of self (must be 'ximgproc_DisparityGuidedFilter' or its derivative)");
    cv::ximgproc::DisparityGuidedFilter* _self_ = dynamic_cast<cv::ximgproc::DisparityGuidedFilter*>(((pyopencv_ximgproc_DisparityGuidedFilter_t*)self)->v.get());
    double retval;

    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ERRWRAP2(retval = _self_->getEps());
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_ximgproc_ximgproc_DisparityGuidedFilter_getRadius(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv::ximgproc;
...
static PyObject* pyopencv_cv_ximgproc_ximgproc_DisparityGuidedFilter_setEps(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv::ximgproc;
    ...
    const char* keywords[] = { "_eps", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "d:ximgproc_DisparityGuidedFilter.setEps", (char**)keywords, &_eps) )
    {
        ERRWRAP2(_self_->setEps(_eps));
        Py_RETURN_NONE;
    }
...
static PyObject* pyopencv_cv_ximgproc_ximgproc_DisparityGuidedFilter_setRadius(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv::ximgproc;
    ...
    const char* keywords[] = { "_radius", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "i:ximgproc_DisparityGuidedFilter.setRadius", (char**)keywords, &_radius) )
    {
        ERRWRAP2(_self_->setRadius(_radius));
        Py_RETURN_NONE;
    }
...
static PyMethodDef pyopencv_ximgproc_DisparityGuidedFilter_methods[] =
{
    {"getEps", (PyCFunction)pyopencv_cv_ximgproc_ximgproc_DisparityGuidedFilter_getEps, METH_VARARGS | METH_KEYWORDS, "getEps() -> retval"},
    {"getRadius", (PyCFunction)pyopencv_cv_ximgproc_ximgproc_DisparityGuidedFilter_getRadius, METH_VARARGS | METH_KEYWORDS, "getRadius() -> retval"},
    {"setEps", (PyCFunction)pyopencv_cv_ximgproc_ximgproc_DisparityGuidedFilter_setEps, METH_VARARGS | METH_KEYWORDS, "setEps(_eps) -> None"},
    {"setRadius", (PyCFunction)pyopencv_cv_ximgproc_ximgproc_DisparityGuidedFilter_setRadius, METH_VARARGS | METH_KEYWORDS, "setRadius(_radius) -> None"},

    {NULL,          NULL}
};

static void pyopencv_ximgproc_DisparityGuidedFilter_specials(void)
{
    pyopencv_ximgproc_DisparityGuidedFilter_Type.tp_base = &pyopencv_ximgproc_DisparityFilter_Type;
    pyopencv_ximgproc_DisparityGuidedFilter_Type.tp_dealloc = pyopencv_ximgproc_DisparityGuidedFilter_dealloc;
    pyopencv_ximgproc_DisparityGuidedFilter_Type.tp_repr = pyopencv_ximgproc_DisparityGuidedFilter_repr;
    pyopencv_ximgproc_DisparityGuidedFilter_Type.tp_getset = pyopencv_ximgproc_DisparityGuidedFilter_getseters;
    pyopencv_ximgproc_DisparityGuidedFilter_Type.tp_methods = pyopencv_ximgproc_DisparityGuidedFilter_methods;
}
...
static PyObject* pyopencv_ximgproc_WeightedLeastSquaresFilter_repr(PyObject* self)
{
    char str[1000];
    sprintf(str, "<ximgproc_WeightedLeastSquaresFilter %p>", self);
    return PyString_FromString(str);
}



static PyGetSetDef pyopencv_ximgproc_WeightedLeastSquaresFilter_getseters[] =
{
    {NULL}  /* Sentinel */
};

static PyObject* pyopencv_cv_ximgproc_ximgproc_WeightedLeastSquaresFilter_filter(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv::ximgproc;

    if(!PyObject_TypeCheck(self, &pyopencv_ximgproc_WeightedLeastSquaresFilter_Type))
        return failmsgp("Incorrect type of self (must be 'ximgproc_WeightedLeastSquaresFilter' or its derivative)");
    cv::ximgproc::WeightedLeastSquaresFilter* _self_ = dynamic_cast<cv::ximgproc::WeightedLeastSquaresFilter*>(((pyopencv_ximgproc_WeightedLeastSquaresFilter_t*)self)->v.get());
    PyObject* pyobj_src = NULL;
    Mat src;
    PyObject* pyobj_dst = NULL;
    Mat dst;
    ...
    const char* keywords[] = { "src", "dst", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:ximgproc_WeightedLeastSquaresFilter.filter", (char**)keywords, &pyobj_src, &pyobj_dst) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 1)) )
    {
...
static PyMethodDef pyopencv_ximgproc_WeightedLeastSquaresFilter_methods[] =
{
    {"filter", (PyCFunction)pyopencv_cv_ximgproc_ximgproc_WeightedLeastSquaresFilter_filter, METH_VARARGS | METH_KEYWORDS, "filter(src[, dst]) -> dst"},

    {NULL,          NULL}
};

static void pyopencv_ximgproc_WeightedLeastSquaresFilter_specials(void)
{
    pyopencv_ximgproc_WeightedLeastSquaresFilter_Type.tp_base = &pyopencv_Algorithm_Type;
    pyopencv_ximgproc_WeightedLeastSquaresFilter_Type.tp_dealloc = pyopencv_ximgproc_WeightedLeastSquaresFilter_dealloc;
    pyopencv_ximgproc_WeightedLeastSquaresFilter_Type.tp_repr = pyopencv_ximgproc_WeightedLeastSquaresFilter_repr;
    pyopencv_ximgproc_WeightedLeastSquaresFilter_Type.tp_getset = pyopencv_ximgproc_WeightedLeastSquaresFilter_getseters;
    pyopencv_ximgproc_WeightedLeastSquaresFilter_Type.tp_methods = pyopencv_ximgproc_WeightedLeastSquaresFilter_methods;
}
