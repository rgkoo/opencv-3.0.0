...
static PyMethodDef methods_ximgproc[] = {
    ...
    {"createDisparityDTFilter", (PyCFunction)pyopencv_cv_ximgproc_createDisparityDTFilter, METH_VARARGS | METH_KEYWORDS, "createDisparityDTFilter() -> retval"},
    {"createDisparityGuidedFilter", (PyCFunction)pyopencv_cv_ximgproc_createDisparityGuidedFilter, METH_VARARGS | METH_KEYWORDS, "createDisparityGuidedFilter() -> retval"},
    {"createDisparityWLSFilter", (PyCFunction)pyopencv_cv_ximgproc_createDisparityWLSFilter, METH_VARARGS | METH_KEYWORDS, "createDisparityWLSFilter() -> retval"},
    ...
    {"createWeightedLeastSquaresFilter", (PyCFunction)pyopencv_cv_ximgproc_createWeightedLeastSquaresFilter, METH_VARARGS | METH_KEYWORDS, "createWeightedLeastSquaresFilter(guide, lambda, sigma_color[, num_iter]) -> retval"},
    ...
    {"weightedLeastSquaresFilter", (PyCFunction)pyopencv_cv_ximgproc_weightedLeastSquaresFilter, METH_VARARGS | METH_KEYWORDS, "weightedLeastSquaresFilter(guide, src, lambda, sigma_color[, dst[, num_iter]]) -> dst"},
    {NULL, NULL}
};
